...
#define GRAD_IDC_INFOBOXPICTEXT         56999
...
#define GRAD_HORIZONTALLINE_H           (0.0015 * Y_SCALE)
...
#define GRAD_INFOBOX_H                  (GRAD_CONTENTAREA_H / 2)

#define GRAD_INFOBOXPIC_W               (GRAD_INFOBOX_W / 3)
#define GRAD_INFOBOXPIC_X               CENTER(GRAD_INFOBOX_X + GRAD_INFOBOX_W, GRAD_INFOBOXPIC_W)
#define GRAD_INFOBOXPIC_H               ((GRAD_CONTENTAREA_H / 2) - GRAD_SPACER_Y)
#define GRAD_INFOBOXPIC_Y               (GRAD_CONTENTAREA_Y + GRAD_INFOBOX_H + GRAD_SPACER_Y)
